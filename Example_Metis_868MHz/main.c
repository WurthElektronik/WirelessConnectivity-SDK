...
static void Metis_Application()
{
    ...
    ret = Metis_Init(9600, Metis_PIN_RESET, MBus_Frequency_868, MBus_Mode_868_S2, true, RXcallback);
...
static void Metis_rx_test()
{
    ...
    /* initialize the module Metis */
    ret = Metis_Init(9600, Metis_PIN_RESET, MBus_Frequency_868, MBus_Mode_868_T2_other, true, RXcallback);
    Debug_out("Metis init", ret);
