...
/* Pins */
#define ProteusIII_PIN_RESET  7  // LED Pin - wiringPi (pin 7 - BCM_GPIO 4).
#define ProteusIII_PIN_WAKEUP 0  // LED Pin - wiringPi (pin 0 - BCM_GPIO 17)
#define ProteusIII_PIN_BOOT   2  // LED Pin - wiringPi (pin 2 - BCM_GPIO Rv1)
