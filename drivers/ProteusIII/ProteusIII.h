...
#define ProteusIII_PIN_RESET  4   // BCM_GPIO 4
#define ProteusIII_PIN_WAKEUP 17  // BCM_GPIO 17
#define ProteusIII_PIN_BOOT   27  // BCM_GPIO 27
#elif defined wiringPi_numbers
#define ProteusIII_PIN_RESET  7  // wiringPi (pin 7 - BCM_GPIO 4
#define ProteusIII_PIN_WAKEUP 0  // wiringPi (pin 0 - BCM_GPIO 17
#define ProteusIII_PIN_BOOT   2  // wiringPi (pin 2 - BCM_GPIO 27
#else
...
extern bool ProteusIII_Init(int baudrate, int rp, int wp, int bp, ProteusIII_CallbackConfig_t callbackConfig);
