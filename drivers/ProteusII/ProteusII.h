...
#define ProteusII_PIN_RESET  4   // BCM_GPIO 4
#define ProteusII_PIN_WAKEUP 17  // BCM_GPIO 17
#define ProteusII_PIN_BOOT   27  // BCM_GPIO 27
#elif defined wiringPi_numbers
#define ProteusII_PIN_RESET  7  // wiringPi (pin 7 - BCM_GPIO 4
#define ProteusII_PIN_WAKEUP 0  // wiringPi (pin 0 - BCM_GPIO 17
#define ProteusII_PIN_BOOT   2  // wiringPi (pin 2 - BCM_GPIO 27
#else
