...
#define ABSOLUTE_ZERO -2732 //-273.2°C
...
HTS221_Error_et HTS221_Init(int address)
{
    i2c_address = address;
...
HTS221_Error_et HTS221_ReadReg(int RegAddr, int NumByteToRead, uint8_t* Data)
{
    int ret = 0;
...
HTS221_Error_et HTS221_WriteReg(int RegAddr, int NumByteToWrite, uint8_t* Data)
{
    if (NumByteToWrite > 1)
    {
...
HTS221_Error_et HTS221_Get_Temperature(int16_t *value)
{
    ...
    {
        *value = (int16_t)(tmp32 /(T1_out - T0_out))  + T0_degC*10;
    }
