...
static bool InitDriver(void(*RXcb)(uint8_t*,uint8_t,uint8_t,uint8_t,uint8_t,int8_t), TelestoIII_AddressMode_t addrmode);
...
TelestoIII_AddressMode_t addressmode = AddressMode_0;  /* initial address mode */
...
/*
 *Initialize the TelestoIII and driver
 *
 *input:
...
static bool InitDriver(void(*RXcb)(uint8_t*,uint8_t,uint8_t,uint8_t,uint8_t,int8_t), TelestoIII_AddressMode_t addrmode)
{
    ...
    if(TelestoIII_GetFirmwareVersion(response))
    {
 ...
 *       false otherwise
 */
bool TelestoIII_Init(int baudrate, int rp, int wp, int bp, void(*RXcb)(uint8_t*,uint8_t,uint8_t,uint8_t,uint8_t,int8_t), TelestoIII_AddressMode_t addrmode)
{
