...
/* Pins */
#define TarvosIII_PIN_RESET  7  // LED Pin - wiringPi (pin 7 - BCM_GPIO 4).
#define TarvosIII_PIN_WAKEUP 0  // LED Pin - wiringPi (pin 0 - BCM_GPIO 17)
#define TarvosIII_PIN_PWM    1  // LED Pin - wiringPi (pin 1 - BCM_GPIO 18)
#define TarvosIII_PIN_BOOT   2  // LED Pin - wiringPi (pin 2 - BCM_GPIO Rv1)
#define TarvosIII_PIN_RTS    4  // LED Pin - wiringPi (pin 4 - BCM_GPIO 23)
#define TarvosIII_PIN_CTS    5  // LED Pin - wiringPi (pin 5 - BCM_GPIO 24)
