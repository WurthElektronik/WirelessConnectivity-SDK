...
static int i2c_handle; // handle of the i2c interface
static int i2c_address; // address of the initialized i2c device

LPS22HB_Error_et LPS22HB_ReadReg(int RegAddr, int NumByteToRead, uint8_t* Data)
{
    int ret = 0;

    if (NumByteToRead > 1)
    {
        RegAddr |= BURST; // add burst bit to allow reading of registers larger than 8bit
    }

    ret = wiringPiI2CReadReg8  (i2c_handle, RegAddr);
    if (ret == -1)
    {
        /* error */
    ...
    else
    {
        ...
        int i;
        for (i = 1; i<NumByteToRead; i++)
        {
            ret = wiringPiI2CRead(i2c_handle);
            if (ret == -1)
            {
                /* error */
                return LPS22HB_ERROR;
...
LPS22HB_Error_et LPS22HB_WriteReg(int RegAddr, int NumByteToWrite, uint8_t* Data)
{
    if (NumByteToWrite > 1)
    {
        RegAddr |= BURST; // add burst bit to allow writing of registers larger than 8bit
    }

    if (0x00 != wiringPiI2CWriteReg8(i2c_handle,RegAddr,Data[0]))
    {
        /* error */
        return LPS22HB_ERROR;
    }
...
* @retval Error Code [LPS22HB_ERROR, LPS22HB_OK]
*/
LPS22HB_Error_et LPS22HB_Set_PowerMode(LPS22HB_PowerMode_et mode)
{
    uint8_t tmp;
...
* @retval Error Code [LPS22HB_ERROR, LPS22HB_OK]
*/
LPS22HB_Error_et LPS22HB_Get_PowerMode(LPS22HB_PowerMode_et* mode)
{
    uint8_t tmp;
...
* @retval Error Code [LPS22HB_ERROR, LPS22HB_OK]
*/
LPS22HB_Error_et LPS22HB_Set_Odr(LPS22HB_Odr_et odr)
{
    uint8_t tmp;
...
* @retval Error Code [LPS22HB_ERROR, LPS22HB_OK]
*/
LPS22HB_Error_et LPS22HB_Set_LowPassFilter(LPS22HB_State_et state)
{
    uint8_t tmp;
...
* @retval Error Code [LPS22HB_ERROR, LPS22HB_OK]
*/
LPS22HB_Error_et LPS22HB_Set_LowPassFilterCutoff(LPS22HB_LPF_Cutoff_et cutoff)
{
...
LPS22HB_Error_et LPS22HB_Set_Bdu(LPS22HB_Bdu_et bdu)
{
    uint8_t tmp;
...
* @retval Error Code [LPS22HB_ERROR, LPS22HB_OK]
*/
LPS22HB_Error_et LPS22HB_Set_SpiInterface(LPS22HB_SPIMode_et spimode)
{
    uint8_t tmp;
...
* @retval Error Code [LPS22HB_ERROR, LPS22HB_OK]
*/
LPS22HB_Error_et LPS22HB_SwResetAndMemoryBoot(void)
{
    uint8_t tmp;
...
* @retval Error Code [LPS22HB_ERROR, LPS22HB_OK]
*/
LPS22HB_Error_et LPS22HB_Set_FifoModeUse(LPS22HB_State_et status)
{
    uint8_t tmp;
...
* @retval  Error Code [LPS22HB_ERROR, LPS22HB_OK]
*/
LPS22HB_Error_et LPS22HB_Set_FifoWatermarkLevelUse(LPS22HB_State_et status)
{
    uint8_t tmp;
...
* @retval Error Code [LPS22HB_ERROR, LPS22HB_OK]
*/
LPS22HB_Error_et LPS22HB_Set_AutomaticIncrementRegAddress(LPS22HB_State_et status)
{
...
* @retval  Error Code [LPS22HB_ERROR, LPS22HB_OK]
*/
LPS22HB_Error_et LPS22HB_Set_InterruptActiveLevel(LPS22HB_InterruptActiveLevel_et mode)
{
    uint8_t tmp;
...
* @retval  Error Code [LPS22HB_ERROR, LPS22HB_OK]
*/
LPS22HB_Error_et LPS22HB_Set_InterruptOutputType(LPS22HB_OutputType_et output)
{
    uint8_t tmp;
...
* @retval Error Code [LPS22HB_ERROR, LPS22HB_OK]
*/
LPS22HB_Error_et LPS22HB_Set_InterruptControlConfig(LPS22HB_OutputSignalConfig_et config)
{
    uint8_t tmp;
...
* @retval  Error Code [LPS22HB_ERROR, LPS22HB_OK]
*/
LPS22HB_Error_et LPS22HB_Set_DRDYInterrupt(LPS22HB_State_et status)
{
    uint8_t tmp;
...
* @retval  Error Code [LPS22HB_ERROR, LPS22HB_OK]
*/
LPS22HB_Error_et LPS22HB_Set_FIFO_OVR_Interrupt(LPS22HB_State_et status)
{
    uint8_t tmp;
...
* @retval  Error Code [LPS22HB_ERROR, LPS22HB_OK]
*/
LPS22HB_Error_et LPS22HB_Set_FIFO_FTH_Interrupt(LPS22HB_State_et status)
{
    uint8_t tmp;
...
* @retval  Error Code [LPS22HB_ERROR, LPS22HB_OK]
*/
LPS22HB_Error_et LPS22HB_Set_FIFO_FULL_Interrupt(LPS22HB_State_et status)
{
    uint8_t tmp;
...
* @retval  Error Code [LPS22HB_ERROR, LPS22HB_OK]
*/
LPS22HB_Error_et LPS22HB_Set_AutoRifP(void)
{
    uint8_t tmp;
...
* @retval  Error Code [LPS22HB_ERROR, LPS22HB_OK]
*/
LPS22HB_Error_et LPS22HB_ResetAutoRifP(void)
{
    uint8_t tmp;
...
* @retval  Error Code [LPS22HB_ERROR, LPS22HB_OK]
*/
LPS22HB_Error_et LPS22HB_Set_AutoZeroFunction(void)
{
    uint8_t tmp;
...
* @retval Error Code [LPS22HB_ERROR, LPS22HB_OK]
*/
LPS22HB_Error_et LPS22HB_ResetAutoZeroFunction(void)
{
    uint8_t tmp;
...
* @retval Error Code [LPS22HB_ERROR, LPS22HB_OK]
*/
LPS22HB_Error_et LPS22HB_Set_InterruptDifferentialGeneration(LPS22HB_State_et diff_en)
{
    uint8_t tmp;
...
* @retval Error Code [LPS22HB_ERROR, LPS22HB_OK]
*/
LPS22HB_Error_et LPS22HB_LatchInterruptRequest(LPS22HB_State_et status)
{
    uint8_t tmp;
...
* @retval Error Code [LPS22HB_ERROR, LPS22HB_OK]
*/
LPS22HB_Error_et LPS22HB_Set_PLE(LPS22HB_State_et status)
{
    uint8_t tmp;
...
* @retval Error Code [LPS22HB_ERROR, LPS22HB_OK]
*/
LPS22HB_Error_et LPS22HB_Set_PHE(LPS22HB_State_et status)
{
    uint8_t tmp;
...
LPS22HB_Error_et LPS22HB_Get_RawPressure(int32_t *raw_press)
{
    uint8_t buffer[3];
    uint32_t tmp = 0;
...
* @retval   Error Code [LPS22HB_ERROR, LPS22HB_OK]
*/
LPS22HB_Error_et LPS22HB_Get_Pressure(int32_t* Pout)
{
    int32_t raw_press;
...
* @retval   Error Code [LPS22HB_ERROR, LPS22HB_OK]
*/
LPS22HB_Error_et LPS22HB_Get_RawTemperature(int16_t* raw_data)
{
    uint8_t buffer[2];
    uint16_t tmp;
...
* @retval  Error Code [LPS22HB_ERROR, LPS22HB_OK]
*/
LPS22HB_Error_et LPS22HB_Get_Temperature(int16_t* Tout)
{
    int16_t raw_data;
...
* @retval   Error Code [LPS22HB_ERROR, LPS22HB_OK]
*/
LPS22HB_Error_et LPS22HB_Get_PressureThreshold(int16_t* P_ths)
{
    uint8_t tempReg[2];
...
* @retval   Error Code [LPS22HB_ERROR, LPS22HB_OK]
*/
LPS22HB_Error_et LPS22HB_Set_PressureThreshold(int16_t P_ths)
{
    uint8_t buffer[2];
...
* @retval Error Code [LPS22HB_ERROR, LPS22HB_OK]
*/
LPS22HB_Error_et LPS22HB_Set_FifoMode(LPS22HB_FifoMode_et fifomode)
{
    uint8_t tmp;
...
* @retval   Error Code [LPS22HB_ERROR, LPS22HB_OK]
*/
LPS22HB_Error_et LPS22HB_Set_FifoWatermarkLevel(uint8_t wtmlevel)
{
    uint8_t tmp;
...
* @retval Error Code [LPS22HB_ERROR, LPS22HB_OK]
*/
LPS22HB_Error_et LPS22HB_Get_Measurement(LPS22HB_MeasureTypeDef_st *Measurement_Value)
{
    int16_t Tout;
    int32_t Pout;
...
* @retval Error code[LPS22HB_ERROR, LPS22HB_OK]
*/
LPS22HB_Error_et LPS22HB_Init(int address)
{

    i2c_address = address;

    if ((i2c_handle = wiringPiI2CSetup  (i2c_address)) < 0)
    {
        /* error */
    ...
    pLPS22HBInit.LowPassFilter=LPS22HB_ENABLE;
    pLPS22HBInit.LPF_Cutoff=LPS22HB_ODR_9;
    pLPS22HBInit.BDU=LPS22HB_BDU_CONTINUOUS_UPDATE;
    pLPS22HBInit.IfAddInc=LPS22HB_ENABLE; //default LPS22HB_ENABLE
    pLPS22HBInit.Sim= LPS22HB_SPI_3_WIRE;
...
* @retval  Error code[LPS22HB_ERROR, LPS22HB_OK]
*/
LPS22HB_Error_et LPS22HB_Set_GenericConfig(LPS22HB_ConfigTypeDef_st* pxLPS22HBInit)
{
...
* @retval  Error code[LPS22HB_ERROR, LPS22HB_OK]
*/
LPS22HB_Error_et LPS22HB_Set_FifoConfig(LPS22HB_FIFOTypeDef_st* pLPS22HBFIFO)
{
