...
#pragma message "Please note that the I2C address of the LIS3DH is 0x18 if SA0 is connected to GND"
...
#define LIS3DH_Acc_Sensitivity_16g    8  /*!< accelerometer sensitivity with 16 g full scale [mg/LSB] */
