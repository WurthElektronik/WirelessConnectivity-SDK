...
#define CMD_STX 0x02
#define Titania_CMD_TYPE_REQ (0 << 6)
#define Titania_CMD_TYPE_CNF (1 << 6)
#define Titania_CMD_TYPE_IND (2 << 6)
#define Titania_CMD_TYPE_RSP (3 << 6)

#define Titania_CMD_DATA 0x00
#define Titania_CMD_DATA_REQ (Titania_CMD_DATA | Titania_CMD_TYPE_REQ)
#define Titania_CMD_DATA_CNF (Titania_CMD_DATA | Titania_CMD_TYPE_CNF)
#define Titania_CMD_REPEAT_IND (Titania_CMD_DATA | Titania_CMD_TYPE_IND)

#define Titania_CMD_DATAEX 0x01
#define Titania_CMD_DATAEX_REQ (Titania_CMD_DATAEX | Titania_CMD_TYPE_REQ)
#define Titania_CMD_DATAEX_IND (Titania_CMD_DATAEX | Titania_CMD_TYPE_IND)

#define Titania_CMD_SETMODE 0x04
#define Titania_CMD_SETMODE_CNF (Titania_CMD_SETMODE | Titania_CMD_TYPE_CNF)
#define Titania_CMD_SETMODE_IND (Titania_CMD_SETMODE | Titania_CMD_TYPE_IND)

#define Titania_CMD_RESET 0x05
#define Titania_CMD_RESET_REQ (Titania_CMD_RESET | Titania_CMD_TYPE_REQ)
#define Titania_CMD_RESET_CNF (Titania_CMD_RESET | Titania_CMD_TYPE_CNF)
#define Titania_CMD_RESET_IND (Titania_CMD_RESET | Titania_CMD_TYPE_IND)

#define Titania_CMD_SET_CHANNEL 0x06
#define Titania_CMD_SET_CHANNEL_REQ (Titania_CMD_SET_CHANNEL | Titania_CMD_TYPE_REQ)
#define Titania_CMD_SET_CHANNEL_CNF (Titania_CMD_SET_CHANNEL | Titania_CMD_TYPE_CNF)

#define Titania_CMD_SET_DESTNETID 0x07
#define Titania_CMD_SET_DESTNETID_REQ (Titania_CMD_SET_DESTNETID | Titania_CMD_TYPE_REQ)
#define Titania_CMD_SET_DESTNETID_CNF (Titania_CMD_SET_DESTNETID | Titania_CMD_TYPE_CNF)

#define Titania_CMD_SET_DESTADDR 0x08
#define Titania_CMD_SET_DESTADDR_REQ (Titania_CMD_SET_DESTADDR | Titania_CMD_TYPE_REQ)
#define Titania_CMD_SET_DESTADDR_CNF (Titania_CMD_SET_DESTADDR | Titania_CMD_TYPE_CNF)

#define Titania_CMD_SET 0x09
#define Titania_CMD_SET_REQ (Titania_CMD_SET | Titania_CMD_TYPE_REQ)
#define Titania_CMD_SET_CNF (Titania_CMD_SET | Titania_CMD_TYPE_CNF)

#define Titania_CMD_GET 0x0A
#define Titania_CMD_GET_REQ (Titania_CMD_GET | Titania_CMD_TYPE_REQ)
#define Titania_CMD_GET_CNF (Titania_CMD_GET | Titania_CMD_TYPE_CNF)

#define Titania_CMD_GET_SERIALNO 0x0B
#define Titania_CMD_GET_SERIALNO_REQ (Titania_CMD_GET_SERIALNO | Titania_CMD_TYPE_REQ)
#define Titania_CMD_GET_SERIALNO_CNF (Titania_CMD_GET_SERIALNO| Titania_CMD_TYPE_CNF)

#define Titania_CMD_GET_FWRELEASE 0x0C
#define Titania_CMD_GET_FWRELEASE_REQ (Titania_CMD_GET_FWRELEASE | Titania_CMD_TYPE_REQ)
#define Titania_CMD_GET_FWRELEASE_CNF (Titania_CMD_GET_FWRELEASE| Titania_CMD_TYPE_CNF)

#define Titania_CMD_RSSI 0x0D
#define Titania_CMD_RSSI_REQ (Titania_CMD_RSSI | Titania_CMD_TYPE_REQ)
#define Titania_CMD_RSSI_CNF (Titania_CMD_RSSI | Titania_CMD_TYPE_CNF)

#define Titania_CMD_SET_PAPOWER 0x11
#define Titania_CMD_SET_PAPOWER_REQ (Titania_CMD_SET_PAPOWER | Titania_CMD_TYPE_REQ)
#define Titania_CMD_SET_PAPOWER_CNF (Titania_CMD_SET_PAPOWER | Titania_CMD_TYPE_CNF)

#ifdef _USE_FACTORY_RESET
#define Titania_CMD_FACTORY_RESET 0x12
#define Titania_CMD_FACTORY_RESET_REQ (Titania_CMD_FACTORY_RESET | Titania_CMD_TYPE_REQ)
#define Titania_CMD_FACTORY_RESET_CNF (Titania_CMD_FACTORY_RESET | Titania_CMD_TYPE_CNF)
#endif

/* type used to check the response, when a command was sent to the Titania */
...
typedef enum Titania_OperationMode_t
{
    Titania_OperationMode_Transparent = 0x00, /* invalid for operation with this driver */
    Titania_OperationMode_Command = 0x10,
}
Titania_OperationMode_t;
...
static bool Wait4CNF(int max_time_ms, uint8_t expectedCmdConfirmation, CMD_Status_t expectedStatus, bool reset_confirmstate);   /* wait for response, when a command was sent to the Titania */
static bool FillChecksum(uint8_t* array, uint8_t length);                                       /* add the CS needed to finalize the command */
static bool InitDriver(void(*RXcb)(uint8_t*,uint8_t,uint8_t,uint8_t,uint8_t,int8_t), Titania_AddressMode_t addrmode);
...
Titania_AddressMode_t addressmode = AddressMode_0;                        /* initial address mode */
...
/*
 *Initialize the Titania and driver
 *
 *input:
 * -RXcb:      RX callback function
 * -addrmode:  address mode of the Titania
 *
...
static bool InitDriver(void(*RXcb)(uint8_t*,uint8_t,uint8_t,uint8_t,uint8_t,int8_t), Titania_AddressMode_t addrmode)
{
    ...
    if(Titania_GetFirmwareVersion(response))
    {
...
static void HandleRxPacket(uint8_t*RxBuffer)
{
    ...
    switch (RxPacket.Cmd)
    {
    case Titania_CMD_SETMODE_CNF:
    {
        /* check whether the module returns success */
        if (RxPacket.Data[0] == Titania_OperationMode_Command)
        {
    ...
    case Titania_CMD_RESET_IND:
    {
        cmdConfirmation.status = CMD_Status_Success;
        cmdConfirmation.cmd = Titania_CMD_RESET_IND;
    }
    break;

    case Titania_CMD_DATA_CNF:
    {
        /* check whether the module returns success */
        if (RxPacket.Data[0] == 0x00)
        {
    ...
    case Titania_CMD_GET_SERIALNO_CNF:
    {
    ...
    case Titania_CMD_GET_FWRELEASE_CNF:
    {
    ...
    case Titania_CMD_DATAEX_IND:
    {
        ...
        if (RXcallback != NULL)
        {
            ...
            case AddressMode_0:
            {
                RXcallback(&RxPacket.Data[0], RxPacket.Length - 1, Titania_BROADCASTADDRESS, Titania_BROADCASTADDRESS, Titania_BROADCASTADDRESS, (int8_t)RxPacket.Data[RxPacket.Length-1]);
            }
            break;

            case AddressMode_1:
            {
                RXcallback(&RxPacket.Data[1], RxPacket.Length - 2, Titania_BROADCASTADDRESS, RxPacket.Data[0], Titania_BROADCASTADDRESS, (int8_t)RxPacket.Data[RxPacket.Length-1]);
            }
            break;

            case AddressMode_2:
            {
                RXcallback(&RxPacket.Data[2], RxPacket.Length - 3, RxPacket.Data[0], RxPacket.Data[1], Titania_BROADCASTADDRESS, (int8_t)RxPacket.Data[RxPacket.Length-1]);
            }
            break;
    ...
    case Titania_CMD_SET_CHANNEL_CNF:
    {
    ...
    case Titania_CMD_SET_DESTADDR_CNF:
    {
        /* check whether the module returns success */
        if (RxPacket.Data[0] == 0x00)
        {
    ...
    case Titania_CMD_SET_DESTNETID_CNF:
    {
        /* check whether the module returns success */
        if (RxPacket.Data[0] == 0x00)
        {
    ...
    case Titania_CMD_SET_PAPOWER_CNF:
    {
...
/* function that waits for the return value of Titania (*_CNF), when a command (*_REQ) was sent before */
...
/*
 *Initialize the Titania interface for serial interface
 *
 *input:
 ...
 * -addrmode:  address mode of the Titania
 *
 *Caution: the parameters baudrate and addrmode must match the configured UserSettings of the Titania
 ...
 *          *this parameter can be updated to the correct value (used in Titania_Init function) as soon as no RF packet transmission or reception was performed
 *
 *return true if initialization succeeded
 *       false otherwise
 */
bool Titania_Init(int baudrate, int rp, void(*RXcb)(uint8_t*,uint8_t,uint8_t,uint8_t,uint8_t,int8_t), Titania_AddressMode_t addrmode)
{
    if (false == InitPin(rp))
    {
        /* error */
...
/*
 *Deinitialize the Titania interface
 *
...
/*
 *Reset the Titania by pin
 *
 *return true if reset succeeded
 *       false otherwise
 */
bool Titania_PinReset()
{
    /* set to output mode */
    ...
    /* wait for cnf */
    return Wait4CNF(CMD_WAIT_TIME, Titania_CMD_SETMODE_CNF, CMD_Status_Success, true);
}

/*
 *Reset the Titania by command
 *
 *return true if reset succeeded
 *       false otherwise
 */
bool Titania_Reset()
{
    ...
    uint8_t CMD_ARRAY[4];
    CMD_ARRAY[0] = CMD_STX;
    CMD_ARRAY[1] = Titania_CMD_RESET_REQ;
    CMD_ARRAY[2] = 0x00;
    if(FillChecksum(CMD_ARRAY,sizeof(CMD_ARRAY)))
    {
        ...
        /* wait for cnf */
        ret = Wait4CNF(CMD_WAIT_TIME, Titania_CMD_RESET_CNF, CMD_Status_Success, true);
    }
    return ret;
}

/*
 *Factory reset the Titania
 *
...
#pragma message "Using FactoryReset() is not recommended. This command sets module to transparent mode and makes driver useless!"
    ...
    uint8_t CMD_ARRAY[4];
    CMD_ARRAY[0] = CMD_STX;
    CMD_ARRAY[1] = Titania_CMD_FACTORY_RESET_REQ;
    CMD_ARRAY[2] = 0x00;
    if(FillChecksum(CMD_ARRAY,sizeof(CMD_ARRAY)))
    {
        /* now send CMD_ARRAY */
        ...
        /* wait for cnf */
        ret = Wait4CNF(CMD_WAIT_TIME, Titania_CMD_FACTORY_RESET_CNF CMD_Status_Success, true);
    }
    return ret;
#else
    return false;
...
/*
 *Request the current Titania settings
 *
 *input:
 ...
 *       false otherwise
 */
bool Titania_Get(Titania_UserSettings_t us, uint8_t* response, uint8_t* response_length)
{
    bool ret = false;
    ...
    uint8_t CMD_ARRAY[6];
    CMD_ARRAY[0] = CMD_STX;
    CMD_ARRAY[1] = Titania_CMD_GET_REQ;
    CMD_ARRAY[2] = 0x02;
    CMD_ARRAY[3] = us;
    ...
    case(Titania_USERSETTING_MEMPOSITION_NUMRETRYS):
    case(Titania_USERSETTING_MEMPOSITION_DEFAULTDESTNETID):
    case(Titania_USERSETTING_MEMPOSITION_SOURCENETID):
    case(Titania_USERSETTING_MEMPOSITION_DEFAULTRFTXPOWER):
    case(Titania_USERSETTING_MEMPOSITION_DEFAULTRFCHANNEL):
    case(Titania_USERSETTING_MEMPOSITION_OP_MODE):
    {
        CMD_ARRAY[4] = 0x01;
    }
    break;
    ...
    case(Titania_USERSETTING_MEMPOSITION_DEFAULTDESTADDR):
    case(Titania_USERSETTING_MEMPOSITION_SOURCEADDR):
    case(Titania_USERSETTING_MEMPOSITION_CFG_FLAGS):
    {
        CMD_ARRAY[4] = 0x02;
    }
    break;
    ...
    case(Titania_USERSETTING_MEMPOSITION_UARTBAUDRATE):
    {
        CMD_ARRAY[4] = 0x04;
    }
    default:
    ...
    if(FillChecksum(CMD_ARRAY,sizeof(CMD_ARRAY)))
    {
        ...
        /* wait for cnf */
        if (Wait4CNF(CMD_WAIT_TIME, Titania_CMD_GET_CNF, CMD_Status_Success, true))
        {
...
/*
 *Request multiple of the current Titania settings
 *
 *input:
 ...
 *       false otherwise
 */
bool Titania_GetMultiple(uint8_t startAddress, uint8_t lengthToRead, uint8_t *response, uint8_t *response_length)
{
    bool ret = false;
 ...
 *       false otherwise
 */
bool Titania_Set(Titania_UserSettings_t us, uint8_t* value, uint8_t length)
{
    bool ret = false;
    ...
    CMD_ARRAY[0] = CMD_STX;
    CMD_ARRAY[1] = Titania_CMD_SET_REQ;
    ...
    if(FillChecksum(CMD_ARRAY,sizeof(CMD_ARRAY)))
    {
        ...
        /* wait for cnf */
        ret = Wait4CNF(CMD_WAIT_TIME, Titania_CMD_SET_CNF, CMD_Status_Success, true);
    }
    return ret;
}
 ...
 *       false otherwise
 */
bool Titania_GetFirmwareVersion(uint8_t* fw)
{
    uint8_t CMD_ARRAY[4];
    CMD_ARRAY[0] = CMD_STX;
    CMD_ARRAY[1] = Titania_CMD_GET_FWRELEASE_REQ;
    CMD_ARRAY[2] = 0;
    ...
    if(FillChecksum(CMD_ARRAY,sizeof(CMD_ARRAY)))
    {
        ...
        /* wait for cnf */
        if (Wait4CNF(CMD_WAIT_TIME, Titania_CMD_GET_FWRELEASE_CNF, CMD_Status_Success, true))
        {
 ...
 *       false otherwise
 */
bool Titania_GetSerialNumber(uint8_t* sn)
{
    uint8_t CMD_ARRAY[4];
    CMD_ARRAY[0] = CMD_STX;
    CMD_ARRAY[1] = Titania_CMD_GET_SERIALNO_REQ;
    CMD_ARRAY[2] = 0;
    ...
    if(FillChecksum(CMD_ARRAY,sizeof(CMD_ARRAY)))
    {
        ...
        /* wait for cnf */
        if (Wait4CNF(CMD_WAIT_TIME, Titania_CMD_GET_SERIALNO_CNF, CMD_Status_Success, true))
        {
 ...
 *       false otherwise
 */
bool Titania_GetDefaultTXPower(int8_t* txpower)
{
    uint8_t length;

    if(Titania_Get(Titania_USERSETTING_MEMPOSITION_DEFAULTRFTXPOWER, (uint8_t*)txpower, &length))
    {
        return true;
    }
    else
 ...
 *       false otherwise
 */
bool Titania_GetDefaultDestAddr(uint8_t* destaddr_lsb)
{
    uint8_t length;

    if(Titania_Get(Titania_USERSETTING_MEMPOSITION_DEFAULTDESTADDR, destaddr_lsb, &length))
    {
        return true;
    }
    else
 ...
 *       false otherwise
 */
bool Titania_GetDefaultDestNetID(uint8_t* destnetid)
{

    uint8_t length;

    if(Titania_Get(Titania_USERSETTING_MEMPOSITION_DEFAULTDESTNETID, destnetid, &length))
    {
        return true;
    }
    else
 ...
 *       false otherwise
 */
bool Titania_GetSourceAddr(uint8_t* srcaddr_lsb)
{

    uint8_t length;

    if(Titania_Get(Titania_USERSETTING_MEMPOSITION_SOURCEADDR, srcaddr_lsb, &length))
    {
        return true;
    }
    else
 ...
 *       false otherwise
 */
bool Titania_GetSourceNetID(uint8_t* srcnetid)
{

    uint8_t length;

    if(Titania_Get(Titania_USERSETTING_MEMPOSITION_SOURCENETID, srcnetid, &length))
    {
        return true;
    }
    else
 ...
 *       false otherwise
 */
bool Titania_GetDefaultRFChannel(uint8_t* channel)
{
    uint8_t length;

    if(Titania_Get(Titania_USERSETTING_MEMPOSITION_DEFAULTRFCHANNEL, channel, &length))
    {
        return true;
    }
    else
 ...
 *note: reset the module after the adaption of the setting such that it can take effect
 *note: use this function only in rare case, since flash can be updated only a limited number times
 *note: use Titania_SetVolatile_TXPower for frequent adaption of the TX power
 *
 *return true if request succeeded
 *       false otherwise
 */
bool Titania_SetDefaultTXPower(int8_t txpower)
{
    ...
    return Titania_Set(Titania_USERSETTING_MEMPOSITION_DEFAULTRFTXPOWER, (uint8_t*)&txpower, 1);
}
 ...
 *note: reset the module after the adaption of the setting such that it can take effect
 *note: use this function only in rare case, since flash can be updated only a limited number times
 *note: use Titania_SetVolatile_DestAddr for frequent adaption of the destination address
 *
 *return true if request succeeded
 *       false otherwise
 */
bool Titania_SetDefaultDestAddr(uint8_t destaddr_lsb, uint8_t destaddr_msb)
{
    ...
    help[0] = destaddr_lsb;
    help[1] = destaddr_msb;
    return Titania_Set(Titania_USERSETTING_MEMPOSITION_DEFAULTDESTADDR, help, 2);
}
 ...
 *note: reset the module after the adaption of the setting such that it can take effect
 *note: use this function only in rare case, since flash can be updated only a limited number times
 *note: use Titania_SetVolatile_DestNetID for frequent adaption of the destination net id
 *
 *return true if request succeeded
 *       false otherwise
 */
bool Titania_SetDefaultDestNetID(uint8_t destnetid)
{
    ...
    return Titania_Set(Titania_USERSETTING_MEMPOSITION_DEFAULTDESTNETID, &destnetid, 1);
}
 ...
 *       false otherwise
 */
bool Titania_SetSourceAddr(uint8_t srcaddr_lsb, uint8_t srcaddr_msb)
{
    /*check for invalid address */
    ...
    help[0] = srcaddr_lsb;
    help[1] = srcaddr_msb;
    return Titania_Set(Titania_USERSETTING_MEMPOSITION_SOURCEADDR, help, 2);
}
 ...
 *       false otherwise
 */
bool Titania_SetSourceNetID(uint8_t srcnetid)
{
    ...
    return Titania_Set(Titania_USERSETTING_MEMPOSITION_SOURCENETID, &srcnetid, 1);
}
 ...
 *note: reset the module after the adaption of the setting such that it can take effect
 *note: use this function only in rare case, since flash can be updated only a limited number times
 *note: use Titania_SetVolatile_Channel for frequent adaption of the channel
 *
 *return true if request succeeded
 *       false otherwise
 */
bool Titania_SetDefaultRFChannel(uint8_t channel)
{
    ...
    return Titania_Set(Titania_USERSETTING_MEMPOSITION_DEFAULTRFCHANNEL, &channel, 1);
}
 ...
 *       false otherwise
 */
bool Titania_SetVolatile_TXPower(int8_t power)
{
    bool ret = false;
    ...
    uint8_t CMD_ARRAY[5];
    CMD_ARRAY[0] = CMD_STX;
    CMD_ARRAY[1] = Titania_CMD_SET_PAPOWER_REQ;
    CMD_ARRAY[2] = 0x01;
    CMD_ARRAY[3] = power;
    if(FillChecksum(CMD_ARRAY,sizeof(CMD_ARRAY)))
    {
        ...
        /* wait for cnf */
        ret = Wait4CNF(CMD_WAIT_TIME, Titania_CMD_SET_PAPOWER_CNF, CMD_Status_Success, true);
        powerVolatile = -1;
    }
    return ret;
}
 ...
 *       false otherwise
 */
bool Titania_SetVolatile_Channel(uint8_t channel)
{
    bool ret = false;
    ...
    uint8_t CMD_ARRAY[5];
    CMD_ARRAY[0] = CMD_STX;
    CMD_ARRAY[1] = Titania_CMD_SET_CHANNEL_REQ;
    CMD_ARRAY[2] = 0x01;
    CMD_ARRAY[3] = channel;
    if(FillChecksum(CMD_ARRAY,sizeof(CMD_ARRAY)))
    {
        ...
        */
        ...
        /* wait for cnf */
        ret = Wait4CNF(CMD_WAIT_TIME, Titania_CMD_SET_CHANNEL_CNF, CMD_Status_Success, true);
 ...
 *       false otherwise
 */
bool Titania_SetVolatile_DestNetID(uint8_t destnetid)
{
    bool ret = false;
    if(destnetid > 255)
    {
    ...
    uint8_t CMD_ARRAY[5];
    CMD_ARRAY[0] = CMD_STX;
    CMD_ARRAY[1] = Titania_CMD_SET_DESTNETID_REQ;
    CMD_ARRAY[2] = 0x01;
    ...
    if(FillChecksum(CMD_ARRAY,sizeof(CMD_ARRAY)))
    {
        ...
        /* wait for cnf */
        ret = Wait4CNF(CMD_WAIT_TIME, Titania_CMD_SET_DESTNETID_CNF, CMD_Status_Success, true);
    }
    return ret;
}
 ...
 *       false otherwise
 */
bool Titania_SetVolatile_DestAddr(uint8_t destaddr_lsb, uint8_t destaddr_msb)
{
    bool ret = false;
    ...
    {
        CMD_ARRAY[0] = CMD_STX;
        CMD_ARRAY[1] = Titania_CMD_SET_DESTADDR_REQ;
        CMD_ARRAY[2] = 0x01;
    ...
    if(ret == true)
    {
        ...
        /* wait for cnf */
        ret = Wait4CNF(CMD_WAIT_TIME, Titania_CMD_SET_DESTADDR_CNF, CMD_Status_Success, true);
    }
    return ret;
}
 ...
 *       false otherwise
 */
bool Titania_Transmit(uint8_t* payload, uint8_t length)
{
    bool ret = false;
    ...
    CMD_ARRAY[0] = CMD_STX;
    CMD_ARRAY[1] = Titania_CMD_DATA_REQ;
    CMD_ARRAY[2] = length;
    ...
    if(FillChecksum(CMD_ARRAY,sizeof(CMD_ARRAY)))
    {
        ...
        /* wait for cnf */
        ret = Wait4CNF(CMD_WAIT_TIME, Titania_CMD_DATA_CNF, CMD_Status_Success, true);
    }
    return ret;
}
 ...
 *       false otherwise
 */
bool Titania_Transmit_Extended(uint8_t* payload, uint8_t length, uint8_t channel, uint8_t dest_network_id, uint8_t dest_address_lsb)
{
    bool ret = false;
    ...
    CMD_ARRAY[0] = CMD_STX;
    CMD_ARRAY[1] = Titania_CMD_DATAEX_REQ;
 ...
 *       false otherwise
*/
bool Titania_Configure(Titania_Configuration_t* config, uint8_t config_length, bool factory_reset)
{
    int i = 0;
    uint8_t help_length;
    ...
    {
        /* read current value */
        if(false == Titania_Get(config[i].usersetting, help, &help_length))
        {
            /* error */
            return false;
        }
        ...
        if(memcmp(help,config[i].value,config[i].value_length) != 0)
        {
            ...
            if(false == Titania_Set(config[i].usersetting, config[i].value, config[i].value_length))
            {
                /* error */
                return false;
            }
