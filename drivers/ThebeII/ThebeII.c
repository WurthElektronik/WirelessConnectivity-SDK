...
static bool InitDriver(void(*RXcb)(uint8_t*,uint8_t,uint8_t,uint8_t,uint8_t,int8_t), ThebeII_AddressMode_t addrmode);
...
ThebeII_AddressMode_t addressmode = AddressMode_0;  /* initial address mode */
...
/*
 *Initialize the ThebeII and driver
 *
 *input:
...
static bool InitDriver(void(*RXcb)(uint8_t*,uint8_t,uint8_t,uint8_t,uint8_t,int8_t), ThebeII_AddressMode_t addrmode)
{
    ...
    if(ThebeII_GetFirmwareVersion(response))
    {
 ...
 *       false otherwise
 */
bool ThebeII_Init(int baudrate, int rp, int wp, int bp, void(*RXcb)(uint8_t*,uint8_t,uint8_t,uint8_t,uint8_t,int8_t), ThebeII_AddressMode_t addrmode)
{
